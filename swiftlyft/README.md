...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/IIEWFL/insy7315-final-project-submission-swiftlyft.git
   cd insy7315-final-project-submission-swiftlyft
   ```
...
- **Tumelo**: Authentication & User Management
- **Bops**: Booking & Trip Management
- **Austin**: Payment & Vehicle Management
- **Khumo**: Notifications & Support Systems
